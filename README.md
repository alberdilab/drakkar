...
- `--version`: folder name to create inside `--directory`. For `kegg`, use the KEGG archive date such as `2026-02-01`. For `cazy`, use the upstream dbCAN release label such as `V14`.
